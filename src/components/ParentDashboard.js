...
const ParentDashboard = () => {
  ...
  const [showAddFundsToStudentModal, setShowAddFundsToStudentModal] = useState(false);
    ...
    const fetchData = async () => {
      try {
       ...
       // setUpcomingPayments(mockUpcomingPayments);
        ...
        if (!childrenRes.data.students || childrenRes.data.students.length === 0) {
  ...
  const handleEditStudent = async (e) => {
    ...
    try {
      ...
      await axios.put(`${FHOST}/users/student/${editingStudent.id}`, editStudentForm);
  ...
  const handleAddFundsToStudent = async (e) => {
    ...
    try {
      ...
      alert(`Successfully transferred Ksh ${amount.toLocaleString()} to ${selectedStudent.full_name}'s account!`);
    } catch (error) {
    ...
    datasets: [
      {
        ...
        data: [12000, 19000, 3000, 5000, 2000, 9000],
  ...
  const renderContent = () => {
    ...
    try {
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-6">
              ...
              <div className="p-6 bg-white rounded-2xl shadow-sm hover:shadow-md transition-shadow">
                ...
                <p className="text-3xl font-bold text-purple-600 mt-2">
                  {students.reduce((acc, student) => acc + (student.activeClasses || 0), 0)}
                </p>
              ...
              <div className="p-6 bg-white rounded-2xl shadow-sm hover:shadow-md transition-shadow">
                ...
                >
                  View Schedule <ArrowRightCircleIcon className="w-5 h-5 ml-1" />
                </button>
              </div>
            </div>
              ...
              {students.length > 0 ? (
                  ...
                  >
                    ...
                    <div className="space-y-3">
                      <div>
                        <div className="flex justify-between text-sm mb-1">
                          ...
                          <span className="text-blue-600 font-medium">{student.progress || 0}%</span>
                        </div>
                      ...
                      <div className="flex items-center justify-between text-sm">
                        ...
                        <span className="text-green-600 font-medium">
                          {student.nextLesson ? new Date(student.nextLesson).toLocaleDateString() : 'None'}
                        </span>
                      </div>
                    ...
                    <div className="mt-4 pt-4 border-t border-gray-200 space-y-2">
                      ...
                      <button
                        onClick={() => {
                          try {
                            localStorage.setItem('view_as_student_id', String(student.id));
                            if (student.full_name) {
                              localStorage.setItem('view_as_student_name', String(student.full_name));
                            }
                            if (student.email) {
                              localStorage.setItem('view_as_student_email', String(student.email));
                            }
                          } catch (e) {}
                ...
                <div className="col-span-full text-center py-12">
                  ...
                  <p className="text-gray-500 mb-6">
                    Get started by adding your first student to monitor their progress and manage their education.
                  </p>
                  <button
                    onClick={() => setShowAddStudentModal(true)}
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                  ...
                  <div className="p-4 bg-gradient-to-br from-blue-500 to-blue-600 rounded-xl text-white">
                    <div className="flex items-center justify-between">
                      <div>
                        ...
                        <p className="text-3xl font-bold">Ksh {walletBalance.toLocaleString()}</p>
                      </div>
                      {WalletIcon ? <WalletIcon className="w-12 h-12 text-blue-200" /> : <div className="w-12 h-12 bg-blue-200 rounded-full"></div>}
                    </div>
                  </div>
              ...
              <div className="p-6 bg-white rounded-2xl shadow-sm">
                ...
                <div className="space-y-3">
                  ...
                  >
                    {PlusIcon ? <PlusIcon className="w-5 h-5" /> : <span>+</span>}
                    <span>Add Funds</span>
                  </button>
                  <button
                    onClick={() => setShowUpcomingPaymentsModal(true)}
                  ...
                  >
                    {CalendarIcon ? <CalendarIcon className="w-5 h-5" /> : <span>📅</span>}
        ...
        return (
          <div className="space-y-6">
            ...
            <div className="bg-white p-6 rounded-2xl shadow-sm">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                {students.map((student) => (
                  <div key={student.id} className="p-4 bg-gray-50 rounded-xl border-l-4 border-blue-500">
      ...
      case "feedback":
        return (
          <ParentFeedback parentId={userInfo.id} students={students} />
        );
             ...
             <div className="bg-white rounded-2xl shadow-sm overflow-hidden">
               ...
               <div className="p-6 space-y-4">
                 ...
                 <div className="p-4 bg-blue-50 rounded-lg border border-blue-200">
                   <h4 className="font-medium text-blue-800 mb-3">Current Profile</h4>
                   <div className="space-y-2 text-sm">
                     <div className="flex justify-between">
                       <span className="text-blue-700">Email:</span>
                       <span className="font-medium text-blue-800">{userInfo?.email || 'Not set'}</span>
                     </div>
                     <div className="flex justify-between">
                       <span className="text-blue-700">Username:</span>
                       <span className="font-medium text-blue-800">{userInfo?.username || 'Not set'}</span>
                     </div>
                   </div>
                 </div>
                 ...
                 >
                   <div className="flex items-center">
                     ...
                     <div>
                       <h4 className="font-medium text-gray-800">View Profile</h4>
                       <p className="text-sm text-gray-500">See your current profile details</p>
                     </div>
                   </div>
                   <ArrowRightCircleIcon className="w-5 h-5 text-gray-400" />
                 </div>
  ...
  return (
    ...
    >
      ...
      <div className="flex-1 flex flex-col lg:pl-64">
        <DashboardHeader
          title={navigation.find((n) => n.key === activeTab)?.name || "Dashboard"}
          userInfo={userInfo}
          ...
          <div className="bg-white rounded-2xl p-6 w-full max-w-2xl max-h-[90vh] overflow-y-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div className="space-y-4">
               ...
               {selectedStudent && selectedStudent.lessons && selectedStudent.lessons.filter(lesson => lesson.active).map((lesson) => (
                  <div key={lesson.id} className="p-4 bg-gray-50 rounded-lg border-l-4 border-green-500">
                    ...
                    <div className="text-sm text-gray-600">
                      ...
                      <p>Next Lesson: {lesson.nextLesson ? new Date(lesson.nextLesson).toLocaleString() : 'N/A'}</p>
                    </div>
                  </div>
                ))}
              </div>
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4 z-50">
          <div className="bg-white rounded-2xl p-6 w-full max-w-md">
            ...
            <div className="mb-6 p-4 bg-gray-50 rounded-lg">
              ...
              <p className="text-sm text-gray-600">
                Current Balance: <span className="font-semibold text-green-600">Ksh {selectedStudent.balance || 0}</span>
              </p>
            </div>
            ...
            <div className="space-y-4">
              {upcomingPayments.length > 0 ? (
                upcomingPayments.map((payment) => (
                  <div key={payment.id} className="p-4 bg-gray-50 rounded-lg border-l-4 border-orange-500">
