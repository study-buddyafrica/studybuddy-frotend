...
const MyAccount = () => {
  ...
  const statusInfo = (() => {
    ...
    if (status === 'pending') return { type: 'info', message: 'Verification pending approval.' };
    if (status === 'approved') return { type: 'success', message: 'Account verified!' };
    if (status === 'rejected') return { type: 'error', message: 'Verification rejected. Please update your info.' };
    return null;
  })();
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        {statusInfo && (
          <div className={`p-4 mb-6 rounded-xl ${
            statusInfo.type === 'success' ? 'bg-green-100 text-green-700 border-green-300' :
            statusInfo.type === 'error' ? 'bg-red-100 text-red-700 border-red-300' :
        ...
        {successMessage && <div className="p-4 mb-6 bg-green-100 text-green-700 rounded-xl">{successMessage}</div>}
        {errorMessage && <div className="p-4 mb-6 bg-red-100 text-red-700 rounded-xl">{errorMessage}</div>}

        <form onSubmit={handleSubmit} className="bg-white rounded-2xl shadow-sm p-6 md:p-8">
          
          {/* Profile Photo */}
          <div className="mb-8">
            <label className="block text-lg font-semibold text-[#015575] mb-4">Profile Photo (Required)</label>
            ...
            <div className="grid gap-6 md:grid-cols-2">
              <div>
                ...
                <PhoneInput
                  ...
                  className="w-full px-4 py-3 border border-gray-300 rounded-lg focus-within:ring-2 focus-within:ring-[#015575] focus-within:border-transparent bg-white"
                  disabled={loading}
                />
              </div>
              <div>
              ...
              <div>
                ...
                <input type="text" name="national_identity_number" value={formData.national_identity_number} onChange={handleInputChange} className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#015575]" disabled={loading} />
              </div>
              <div>
              ...
              <div>
                ...
                <input type="number" name="experience" value={formData.experience} onChange={handleInputChange} className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#015575]" disabled={loading} />
              </div>
            </div>
          </div>
          ...
          <div className="bg-gray-50 rounded-xl p-6 mb-6">
            <h3 className="text-xl font-semibold text-[#015575] mb-6">Professional Information</h3>
            <div className="grid gap-6 md:grid-cols-2">
              <div>
                <label className="block text-sm font-medium text-gray-700 mb-2">Teacher License Number</label>
                <input type="text" name="teacher_license_number" value={formData.teacher_license_number} onChange={handleInputChange} className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#015575]" disabled={loading} />
              </div>
              <div>
                <label className="block text-sm font-medium text-gray-700 mb-2">Gender</label>
                <select name="gender" value={formData.gender} onChange={handleInputChange} className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#015575]" disabled={loading}>
          ...
          <div className="bg-gray-50 rounded-xl p-6 mb-6">
            <div className="grid gap-6 md:grid-cols-2">
              <div>
                ...
                <input type="text" value={formData.subjectInput} onChange={handleSubjectChange} className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#015575]" placeholder="e.g. Mathematics" disabled={loading} />
              </div>
              <div>
                <label className="block text-sm font-medium text-gray-700 mb-2">Grade</label>
                <select value={formData.grade_id || formData.gradeInput} onChange={handleGradeChange} className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#015575]" disabled={loading}>
          ...
          <div className="bg-gray-50 rounded-xl p-6 mb-6">
            <h3 className="text-xl font-semibold text-[#015575] mb-6">Documents & Verification</h3>
            <div className="grid gap-6 md:grid-cols-2">
              <div>
                <label className="block text-sm font-medium text-gray-700 mb-2">Identity Verification (National ID / Passport)</label>
                <input
                  type="file"
              ...
              <div>
                <label className="block text-sm font-medium text-gray-700 mb-2">Professional Documents (Academic Cert / License / CV)</label>
                <input
                  type="file"
                  accept=".pdf,.doc,.docx,image/*"
          ...
          {/* Submit */}
          <button type="submit" disabled={loading} className="w-full bg-[#015575] text-white py-3 rounded-xl hover:bg-[#01415e] transition text-lg font-semibold disabled:opacity-50">
