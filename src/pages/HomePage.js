...
const users = [
  ...
  {
    title: "Student",
    role: "student", // corrected from "learner" to "student"
    path: "/signup",
      ...
      <section className="relative min-h-screen flex flex-col sm:flex-row items-center justify-center w-full pt-28 sm:pt-0 pb-6 sm:pb-10 overflow-hidden bg-gradient-to-br from-[#f8fcff] to-[#e1f3ff]     ">
        ...
        >
          <div className="space-y-6 lg:space-y-8 max-w-2xl">
            ...
            >
            StudyBuddy Africa connects learners to curriculum-aligned lessons taught by certified teachers
            </motion.p>
            ...
            <div className="w-full lg:w-1/2 space-y-6 lg:space-y-8">
              <div className="space-y-4 lg:space-y-6">
                <p className="text-lg lg:text-xl text-gray-600 leading-relaxed font-josefin">
                  At{" "}<span className="text-[#027fad] font-bold">
                  StudyBuddy Africa
                  </span>{" "}
                  we believe every student deserves access to trustworthy, high-quality digital education.
                  Our platform is designed and reviewed by experienced teachers and curriculum specialists to ensure that every lesson is accurate, practical, and aligned with national education standards.
                </p>
                <div className="pl-4 border-l-4 border-[#015575]">
                  <p className="text-gray-600 italic font-josefin">
                    "Whether you're revising for exams or exploring new subjects, 
                    StudyBuddy gives you the tools, structure, and support you need to succeed — anytime, anywhere. "
                  </p>
                </div>
             ...
             <p><span className="font-bold">1️⃣ Explore Lessons —</span> Browse topics across subjects, each created and reviewed by verified educators.</p>
             <p><span className="font-bold">2️⃣ Learn & Practice —</span> Watch guided video lessons, take quizzes, and access downloadable notes.</p>
             <p><span className="font-bold">3️⃣ Track Your Progress —</span> Get performance reports and earn digital certificates as you learn.</p>
             </div>
             </div>
      ...
      <section className="relative w-full py-20 px-4 sm:px-8 bg-gradient-to-br from-[#f8fcff] to-[#e1f3ff] overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto relative z-10">
          ...
          >
            ...
            <p className="text-lg text-gray-600 font-josefin max-w-2xl mx-auto">
             Every StudyBuddy instructor is a certified teacher, subject expert, or examiner with years of classroom experience.
            </p>
          </motion.div>
        ...
        <div className="max-w-7xl mx-auto flex flex-col items-center justify-center">
          ...
          >
            ...
            <p className="text-lg text-gray-600 font-josefin max-w-2xl mx-auto">
              ...
              lessons which are hosted on our platform and created exclusively for StudyBuddy learners
            </p>
          </motion.div>
...
<section className="relative w-full py-20 px-4 sm:px-8 bg-gradient-to-br from-[#f8fcff] to-[#e6f7ff]">
  <div className="max-w-7xl mx-auto">
    ...
    <p className="max-w-3xl mx-auto text-center text-lg text-gray-700 mb-16 font-josefin leading-relaxed">
      StudyBuddy Africa partners with schools, education organizations, and community programs 
      to make learning accessible and credible. <br className="hidden sm:block" />
      Join thousands of learners already using StudyBuddy to improve their grades, 
      build confidence, and prepare for their future.
    </p>
