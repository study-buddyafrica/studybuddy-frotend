...
const TutorProfilesPage = () => {
  const tutors = [
    ...
    },
    {
      ...
      qualifications: ['B.A. in English Literature', 'TESOL Certification', '3+ Years Experience'],
        ...
        <div className="max-w-7xl mx-auto px-4 relative z-10">
          ...
          >
            <input
              ...
              className="flex-1 bg-transparent border-none text-white placeholder-white/80 px-6 focus:ring-0"
            />
          ...
          >
            ...
            <div className="pt-16 px-6 pb-6 space-y-6">
              <div className="text-center">
                <h2 className="text-2xl font-bold text-[#015575] font-lilita">{tutor.name}</h2>
                <p className="text-sm text-gray-600 mt-2 font-josefin">{tutor.bio}</p>
              </div>

              {/* Stats Grid */}
              <div className="grid grid-cols-3 gap-4 text-center">
                <div className="bg-[#01B0F1]/10 p-3 rounded-xl">
                  <div className="text-xl font-bold text-[#015575] font-lilita">{tutor.rating}</div>
                  <div className="text-xs text-[#015575] font-josefin">Rating</div>
                </div>
                <div className="bg-[#01B0F1]/10 p-3 rounded-xl">
                  <div className="text-xl font-bold text-[#015575] font-lilita">{tutor.subjects.length}+</div>
                  <div className="text-xs text-[#015575] font-josefin">Subjects</div>
                </div>
                <div className="bg-[#01B0F1]/10 p-3 rounded-xl">
                  <div className="text-xl font-bold text-[#015575] font-lilita">{tutor.qualifications.length}</div>
                  <div className="text-xs text-[#015575] font-josefin">Certs</div>
                </div>
              </div>
                ...
                <div className="space-y-3">
                  {tutor.reviews.map((review, i) => (
                    <div key={i} className="bg-[#01B0F1]/5 p-3 rounded-lg">
                      <p className="text-sm font-josefin text-gray-700">"{review.comment}"</p>
                      <p className="text-xs text-[#015575] mt-2 font-semibold">- {review.student}</p>
                    </div>
                  ))}
                </div>
              </div>
